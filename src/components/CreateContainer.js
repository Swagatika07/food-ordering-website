...
const CreateContainer = () => {
  ...
  return (
    <div className='w-full min-h-screen flex items-center justify-center'>
      <div className='w-[90%] md:w-[75%] border-gray-500 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
      {
        fields && (
  ...
  <div className='w-full py-2 border-b border-gray-300 h-20px flex flex-item-center gap-2'>
  ...
  border-gray-200 p-2 rounded-md cursor-pointer gap-4'>
