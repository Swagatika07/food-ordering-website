...
const CartContainer = () => {
  ...
  return (
    <div className='fixed top-0 right-0 w-full md:w-350 h-screen bg-white drop-shadow-md flex
    flex-col z-[101]'>
      <div className='w-full flex items-start justify-between p-4 cursor-pointer' onClick={showCart}>
      ...
      <div className='w-full flex items-center justify-between'>
        ...
        <p className='text-gray-400 text-lg'>Rs {total}</p>
      </div>
      <div className='w-full flex items-center justify-between'>
      ...
      <div className='w-full flex items-center justify-between'>
        ...
        <p className='text-gray-200 text-xl font-semibold'>Rs {total + 2.5}</p> 
      </div> 
