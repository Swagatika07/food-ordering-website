...
const HomeContainer = () => {
  return (
    <section className='grid grid-cols-1 w-full bg-white p-4 md:grid-cols-2 gap-2 id="home'>
      ...
      <div className='flex items-center gap-2 bg-orange-100 px-2 py-1 rounded-full justify-center'>
      ...
      <p className='text-[2.5rem] md:text-[4rem] font-bold text-headingColor'>The Fastest Delivery to <span className='text-orange-600'>Your Location</span></p>
      ...
      to-orange-500 w-full p-4 px-4 py-2 md:w-auto rounded-lg hover:shadow-lg
